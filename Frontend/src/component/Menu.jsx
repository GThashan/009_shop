  ...
  return (
    <div className="mt-[50px] flex flex-col items-center justify-center">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 px-10 mt-6 gap-4 ietms-center">
        <div className="max-w-[300px]  bg-[#333333] flex flex-col items-center justify-center p-4 rounded shadow-lg cursor-pointer hover:scale-105 transition-transform">
          <img
            src={manuitem}
