...
export default function ImageSlider() {
  return (
    <div className='relative px-8 mx-auto h-[80vh]  flex flex-col md:flex-row'>
     
     <div className='absolute inset-0 flex flex-col items-start justify-center gap-5 p-8  md:relative md:w-1/2 md:inset-auto md:bg-transparent font-bold lg:text-black  '>

        <h1 className='font-bold text-[55px] lg:text-[50px] '>
          Good Meals <span className='text-red-600'>Food</span> For A Healthy Life
        </h1>
